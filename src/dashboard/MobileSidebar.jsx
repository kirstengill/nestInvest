...
const MobileSidebar = ({ open, onClose, onNavClick }) => {
  useEffect(() => {
    if (open) {
    ...
    <>
      ...
      >
        <div className="mobile-sidebar__header">
          ...
          <button className="mobile-sidebar__close" onClick={onClose} aria-label="Close menu">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="mobile-sidebar__footer">
          <button
            className="mobile-sidebar__nav-item mobile-sidebar__nav-item--logout"
