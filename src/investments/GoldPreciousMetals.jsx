...
const METAL_CATEGORIES = ["All", "Gold", "Silver", "Platinum", "Palladium"];
    ...
    <main className="metals-page">
      <div className="metals-page__container">
        ...
        <section className="metals-page__catalog" aria-labelledby="metals-catalog-title">
          ...
          {loading ? (
            <div className="metals-page__state">
              <div className="metals-page__state-icon">Au</div>
              <strong>Loading investments...</strong>
              <p>Fetching available precious metal products from our catalog.</p>
            </div>
          ) : products.length === 0 ? (
            <div className="metals-page__state">
              <div className="metals-page__state-icon">Au</div>
              <strong>No investments available</strong>
              <p>There are currently no active precious metal investment products. Please check back later.</p>
            </div>
          ) : (
            <>
